...
public:
    BuiltInParsables(fx9::pipeline::EffectPipeline::LanguageType language)
        : m_language(language)
    {
    }
        ...
        EShLanguage /* language */, TSymbolTable &symbolTable) override
    {
        ...
        if (m_language == fx9::pipeline::EffectPipeline::kLanguageTypeHLSL) {
...
private:
    ...
    fx9::pipeline::EffectPipeline::LanguageType m_language;
};
...
EffectPipeline::BaseParameterConverter::BaseParameterConverter(
    const ParserContext &parser, EffectPipeline *parent, EffectProduct &effectProduct, void *opaque)
    : m_parser(parser)
...
void
EffectPipeline::BaseParameterConverter::convertAllConstantParameters(void *opaque, size_t &index)
{
...
void
EffectPipeline::BaseParameterConverter::convertAllUniformParameters(void *opaque, size_t &index)
{
    Fx9__Effect__Parameter **parameters = static_cast<Fx9__Effect__Parameter **>(opaque), *parameterPtr = nullptr;
...
void
EffectPipeline::BaseParameterConverter::convertAllSamplerParameters(void *opaque, size_t &index)
{
    Fx9__Effect__Parameter **parameters = static_cast<Fx9__Effect__Parameter **>(opaque), *parameterPtr = nullptr;
...
void
EffectPipeline::BaseParameterConverter::convertAllTextureParameters(void *opaque, size_t &index)
{
    Fx9__Effect__Parameter **parameters = static_cast<Fx9__Effect__Parameter **>(opaque), *parameterPtr = nullptr;
...
void
EffectPipeline::BaseParameterConverter::convertAll()
{
...
void
EffectPipeline::BaseParameterConverter::fillParameterValues(const ParserContext::NodeItem *value, void *opaque)
{
    if (value) {
...
void
EffectPipeline::BaseParameterConverter::fillParameterFromConstantUnionNode(
...
void
EffectPipeline::BaseParameterConverter::assignIntegerParameter(void *opaque, size_t offset, int value)
{
    Fx9__Effect__Parameter *parameterPtr = static_cast<Fx9__Effect__Parameter *>(opaque);
...
void
EffectPipeline::BaseParameterConverter::assignFloatParameter(void *opaque, size_t offset, float value)
{
    Fx9__Effect__Parameter *parameterPtr = static_cast<Fx9__Effect__Parameter *>(opaque);
    auto typed = parameterPtr->type_common;
    switch (typed) {
...
void
EffectPipeline::BaseParameterConverter::convertParameterType(const glslang::TType &type, void *opaque)
{
    Fx9__Effect__Parameter *parameterPtr = static_cast<Fx9__Effect__Parameter *>(opaque);
...
void
EffectPipeline::BaseParameterConverter::convertParameter(const glslang::TType &type, const glslang::TString &name,
...
EffectPipeline::BasePassShader::BasePassShader(
    EffectPipeline *parent, const char *path, const glslang::TString &source, EffectProduct &effectProduct, void *opaque)
    : m_source(source)
    , m_path(path)
    , m_effectProduct(effectProduct)
    , m_parent(parent)
...
void
EffectPipeline::BasePassShader::convertPassState(
...
void
EffectPipeline::BasePassShader::convertAllSamplerStates(const TIntermAggregate *samplerStates, void *opaque) const
{
...
bool
EffectPipeline::BasePassShader::generateSPVInstructions(ParserContext &parser,
...
bool
EffectPipeline::BasePassShader::compile(
...
void
EffectPipeline::BasePassShader::convertAllPassStates(const ParserContext::Pass &pass)
{
    Fx9__Effect__Pass *message = static_cast<Fx9__Effect__Pass *>(m_opaque);
...
configurePointSizeAssignment(ParserContext &parser, Fx9__Effect__Pass *message)
{
    ...
    for (size_t i = 0, numStates = message->n_render_states; i < numStates; i++) {
        ...
        else if (state->key == 157) {
            pointScaleEnabled = state->value != 0;
        }
        else if (state->key == 158) {
            pointScaleA = decodeRenderStateFloatValue(state->value);
        }
        else if (state->key == 159) {
            pointScaleB = decodeRenderStateFloatValue(state->value);
        }
        else if (state->key == 160) {
            pointScaleC = decodeRenderStateFloatValue(state->value);
        }
    }
...
void
EffectPipeline::GLSLPassShader::configureParserContext(ParserContext &parser)
{
    Fx9__Effect__Pass *message = static_cast<Fx9__Effect__Pass *>(m_opaque);
...
bool
EffectPipeline::GLSLPassShader::translate(const InstructionList &vertexShaderInstructions,
...
EffectPipeline::HLSLPassShader::HLSLPassShader(
    EffectPipeline *parent, const char *path, const glslang::TString &source, EffectProduct &effectProduct, void *opaque)
    : BasePassShader(parent, path, source, effectProduct, opaque)
{
}
...
void
EffectPipeline::HLSLPassShader::configureParserContext(ParserContext &parser)
{
    Fx9__Effect__Pass *message = static_cast<Fx9__Effect__Pass *>(m_opaque);
    configurePointSizeAssignment(parser, message);
...
bool
EffectPipeline::HLSLPassShader::translate(const InstructionList &vertexShaderInstructions,
    const InstructionList &fragmentShaderInstructions, std::string &translatedVertexShaderSource,
    std::string &translatedFragmentShaderSource, EffectProduct::LogSink &sink)
{
    fx9::graphics::HostServices host;
...
EffectPipeline::MSLPassShader::MSLPassShader(
    EffectPipeline *parent, const char *path, const glslang::TString &source, EffectProduct &effectProduct, void *opaque)
    : BasePassShader(parent, path, source, effectProduct, opaque)
{
}
...
void
EffectPipeline::MSLPassShader::configureParserContext(ParserContext &parser)
{
    Fx9__Effect__Pass *message = static_cast<Fx9__Effect__Pass *>(m_opaque);
    configurePointSizeAssignment(parser, message);
    parser.enableUniformBuffer();
...
bool
EffectPipeline::MSLPassShader::translate(const InstructionList &vertexShaderInstructions,
    const InstructionList &fragmentShaderInstructions, std::string &translatedVertexShaderSource,
    std::string &translatedFragmentShaderSource, EffectProduct::LogSink &sink)
{
    fx9::graphics::HostServices host;
...
EffectPipeline::SPIRVPassShader::SPIRVPassShader(
    EffectPipeline *parent, const char *path, const glslang::TString &source, EffectProduct &effectProduct, void *opaque)
    : BasePassShader(parent, path, source, effectProduct, opaque)
{
}
...
bool
EffectPipeline::compile(const char *path, EffectProduct &effectProduct)
{
    bool result = false;
#if defined(_WIN32)
...
bool
EffectPipeline::compile(const std::string &source, const char *filename, EffectProduct &effectProduct)
{
...
void
EffectPipeline::addIncludeSource(const std::string &filePath, const std::string &sourceData)
{
    m_includeSourceData.insert(std::make_pair(filePath, sourceData));
}

void
EffectPipeline::setDefineMacro(const std::string &key, const std::string &value)
{
    m_macros[key] = value;
}

bool
EffectPipeline::containsDefineMacro(const std::string &key) const
{
    return m_macros.find(key) != m_macros.end();
}

void
EffectPipeline::removeDefineMacro(const std::string &key)
{
    m_macros.erase(key);
}

int
EffectPipeline::version() const
{
    return m_version;
}

void
EffectPipeline::setVersion(int value)
{
    if (m_version != value) {
        m_version = value;
    }
...
EffectPipeline::vertexShaderInputLocations() const
{
    return m_vertexShaderInputLocations;
}

void
EffectPipeline::setVertexShaderInputLocations(const ParserContext::BuiltInLocationMap &value)
{
    m_vertexShaderInputLocations = value;
}

ParserContext::BuiltInVariableMap
EffectPipeline::vertexShaderInputVariables() const
{
    return m_vertexShaderInputVariables;
}

void
EffectPipeline::setVertexShaderInputVariables(const ParserContext::BuiltInVariableMap &value)
{
    m_vertexShaderInputVariables = value;
}

ParserContext::BuiltInVariableMap
EffectPipeline::pixelShaderInputVariables() const
{
    return m_pixelShaderInputVariables;
}

void
EffectPipeline::setPixelShaderInputVariables(const ParserContext::BuiltInVariableMap &value)
{
    m_pixelShaderInputVariables = value;
}

std::string
EffectPipeline::metalShaderEntryPoint() const
{
    return m_metalShaderEntryPointName;
}

void
EffectPipeline::setMetalShaderEntryPoint(const std::string &value)
{
    m_metalShaderEntryPointName = value;
}

std::string
EffectPipeline::metalShaderUniformBufferName() const
{
    return m_metalShaderUniformBufferName;
}

void
EffectPipeline::setMetalShaderUniformBufferName(const std::string &value)
{
    m_metalShaderUniformBufferName = value;
}

EffectPipeline::LanguageType
EffectPipeline::targetLanguage() const
{
    return m_language;
}

void
EffectPipeline::setTargetLanguage(EffectPipeline::LanguageType value)
{
    if (m_language != value) {
        switch (value) {
...
bool
EffectPipeline::isOptimizeEnabled() const
{
    return m_enableOptimize;
}

void
EffectPipeline::setOptimizeEnabled(bool value)
{
    m_enableOptimize = value;
}

bool
EffectPipeline::isValidationEnabled() const
{
    return m_enableValidation;
}

void
EffectPipeline::setValidationEnabled(bool value)
{
...
template <typename TType>
TType **
EffectPipeline::allocateArray(size_t numItems)
{
    assert(numItems > 0);
...
uint32_t
EffectPipeline::resolveRenderStateValue(const ParserContext::PassState &state, const Convertions &conversions)
{
...
uint32_t
EffectPipeline::resolveSamplerStateValue(const TIntermSymbol *valueNode, const Convertions &conversions)
{
    const TString &value = valueNode ? valueNode->getName() : TString();
    TString valueUpperCase(value);
    std::transform(value.begin(), value.end(), valueUpperCase.begin(), ::toupper);
...
void
EffectPipeline::copyString(const TString &source, TPoolAllocator &allocator, char **destinationPtr)
{
...
void
EffectPipeline::initializeBuiltInSymbolTable(const TString &builtIn, EShLanguage language, TSymbolTable &outputSymbolTable)
{
...
void
EffectPipeline::initializeBuiltInSymbolTable(
...
bool
EffectPipeline::addContextSpecificSymbols(const TBuiltInResource *resources, EShLanguage language, TSymbolTable &symbolTable)
{
    const SpvVersion &spv = createSpvVersion();
...
void
EffectPipeline::compileAllTechniques(const ParserContext::TechniqueList &techniques, const char *path, const TString &source,
...
void
EffectPipeline::compileAllPasses(const ParserContext::Technique &technique, const char *path, const glslang::TString &source,
    EffectProduct &effectProduct, void *opaque)
{
...
void
EffectPipeline::convertAnnotation(const TString &name, const TIntermNode *value, void *opaque)
{
...
void
EffectPipeline::convertAllAnnotations(const ParserContext::AnnotationList &annotations, void *opaque, size_t *numAnnotations)
{
...
void
EffectPipeline::convertAllParameterAnnotations(const TIntermTyped *annotationsNode, void *opaque)
{
    Fx9__Effect__Parameter *parameterPtr = static_cast<Fx9__Effect__Parameter *>(opaque);
...
void
EffectPipeline::convertMetadata(const TUnorderedMap<TString, TString> &value, void *opaque)
{
    Fx9__Effect__Effect *message = static_cast<Fx9__Effect__Effect *>(opaque);
    if (!value.empty()) {
...
void
EffectPipeline::convertIncludePathSet(const ParserContext &parser, void *opaque)
{
    Fx9__Effect__Effect *message = static_cast<Fx9__Effect__Effect *>(opaque);
...
bool
EffectPipeline::generateSPVInstructions(const ParserContext::Pass::EntryPoint &entryPoint, const glslang::TString &source,
...
void
EffectPipeline::saveAttributeMap(const InstructionList &instructions, std::unordered_map<uint32_t, std::string> &attributes)
{
...
void
EffectPipeline::restoreInterfaceVariableNames(
...
void
EffectPipeline::optimizeShaderInstructions(
...
bool
EffectPipeline::validateShaderSource(
...
void
EffectPipeline::rebuildAllSymbolTables()
{
